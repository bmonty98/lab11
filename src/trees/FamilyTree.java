...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("invalid line no colon found");
		...
		else
		{
			...
			if(parent == null) {
				...
				throw new TreeException("AHHHHHHHHHH");
			}
			//HELP JASON?????  //There's a method in Node that searches for a named node. 
...
//			//??? Throw a TreeException with a useful message
		throw new TreeException("AAAAAAAAAAAAAAAA");
		}
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null) {
			
			throw new TreeException("AYYYYYYYYYYYY");
		}
//		
